Public Class frmLab3
    Private Sub btnUp_Click(sender As Object, e As EventArgs) Handles btnUp.Click
        txtDigis.Text = Val(txtDigis.Text) + (3)
    End Sub
    ...
    Private Sub cboSize_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboSelect.SelectedIndexChanged
        Dim Size As Integer = Val(cboSelect.Text)
        txtDigis.Font = New Font(txtDigis.Font.Name, Size, FontStyle.Bold)
    End Sub
